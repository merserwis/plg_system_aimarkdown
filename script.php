...
class PlgSystemAimarkdownInstallerScript extends InstallerScript
{
    ...
    /**
     * Create local database table for logging AI visits.
     */
    private function createAnalyticsTable(): void
    {
        try {
            ...
            // Silently catch database creation errors
        }
    }

    /**
     * Move the plugin to the end of the execution queue and enable it.
     */
    ...
    /**
     * Purge Joomla application cache, plugin cache, and PHP OPcache.
     */
